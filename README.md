...
As a firmware synthesizer, i used opensource Yosys/Apicula/NextPNR, because due to war sanctions, we here in Russia were cut off from many programs, including Gowin IDE free license program. UPD. Using Gowin IDE for synthesize, results were the same. It seems that prorerly working async FIFO is required.
